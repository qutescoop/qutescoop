...
class PreferencesDialog
    ...
    private slots:
        ...
        void on_btnCongestionShowRing_toggled(bool checked);
        void on_btnCongestionShowGlow_toggled(bool checked);
        void on_sbCongestionMovementsMin_valueChanged(int);
        void on_sbCongestionRadiusMin_valueChanged(int arg1);
        void on_sbCongestionBorderLineStrengthMin_valueChanged(double value);
        void on_pbCongestionColorMin_clicked();
        void on_sbCongestionMovementsMax_valueChanged(int);
        void on_sbCongestionRadiusMax_valueChanged(int arg1);
        void on_sbCongestionBorderLineStrengthMax_valueChanged(double value);
        void on_pbCongestionColorMax_clicked();
